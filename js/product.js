...
async function setCurrentProduct() {
   try {
      const res = await fetch( 'js/products-data.json', {method: 'GET'} );
...
async function getProvidersInfo() {
   const res = await fetch('js/providers-data.json');
   const data = await res.json();
...
async function getComments() {
   const res = await fetch('js/comments-data.json', {method: 'GET'});
   const data = await res.json();
...
async function getRelatedProducts() {
   const res = await fetch('js/related-products-data.json', {method: 'GET'});
   const data = await res.json();
